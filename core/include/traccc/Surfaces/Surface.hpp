...
#include "traccc/definitions/Alignment.hpp"
...
#include "traccc/geometry/DetectorElementBase.hpp"
#include "traccc/geometry/GeometryContext.hpp"
#include "traccc/geometry/GeometryObject.hpp"
#include "traccc/geometry/Polyhedron.hpp"
#include "traccc/Surfaces/BoundaryCheck.hpp"
#include "traccc/Surfaces/SurfaceBounds.hpp"
#include "traccc/Surfaces/SurfaceError.hpp"
#include "traccc/Surfaces/detail/AlignmentHelper.hpp"
#include "traccc/utils/BinnedArray.hpp"
#include "traccc/utils/BinningType.hpp"
#include "traccc/utils/Intersection.hpp"
...
class Surface : public virtual GeometryObject,
 ...
 public:
  ...
  /// frame
  virtual traccc::RotationMatrix3 referenceFrame(const GeometryContext& gctx,
  ...
  /// should move to :
  /// "traccc/EventData/detail/coordinate_transformations.hpp"
  ///
  /// @param gctx The current geometry context object, e.g. alignment
  ...
  virtual SurfaceMultiIntersection intersect(
      ...
      TracccScalar tolerance = s_onSurfaceTolerance) const = 0;
  ...
  virtual TracccMatrix<2, 3> localCartesianToBoundLocalDerivative(
