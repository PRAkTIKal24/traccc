...
static constexpr TracccScalar s_epsilon =
    3 * std::numeric_limits<TracccScalar>::epsilon();
...
static constexpr TracccScalar s_onSurfaceTolerance = 1e-4;
...
static constexpr TracccScalar s_curvilinearProjTolerance = 0.999995;
