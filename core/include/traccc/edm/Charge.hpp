...
#include "traccc/definitions/Units.hpp"
#include "traccc/edm/ChargeConcept.hpp"
...
TRACCC_STATIC_CHECK_CONCEPT(ChargeConcept, Neutral);
...
TRACCC_STATIC_CHECK_CONCEPT(ChargeConcept, SinglyCharged);
...
TRACCC_STATIC_CHECK_CONCEPT(ChargeConcept, NonNeutralCharge);
...
TRACCC_STATIC_CHECK_CONCEPT(ChargeConcept, AnyCharge);
