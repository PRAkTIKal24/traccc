...
#include "traccc/edm/detail/CalculateResiduals.hpp"
#include "traccc/edm/detail/ParameterTraits.hpp"
#include "traccc/edm/detail/PrintParameters.hpp"
#include "traccc/utils/detail/Subspace.hpp"
...
class Measurement {
 ...
 public:
  ...
  using ParametersVector = TracccVector<kSize>;
  /// Matrix type for the measurement covariance.
  using CovarianceMatrix = TracccSquareMatrix<kSize>;
  /// Vector type containing all parameters in the same space.
  using FullParametersVector = TracccVector<kFullSize>;
  using ProjectionMatrix = TracccMatrix<kSize, kFullSize>;
  using ExpansionMatrix = TracccMatrix<kFullSize, kSize>;
